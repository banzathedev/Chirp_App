package com.grpitsolutions.core.data.networking

import com.grpitsolutions.core.data.BuildKonfig
import com.grpitsolutions.core.data.dto.AuthInfoSerializable
import com.grpitsolutions.core.data.dto.request.RefreshRequest
...
class HttpClientFactory(
    ...
    fun create(engine: HttpClientEngine): HttpClient{
        return HttpClient(engine){
            ...
            defaultRequest {
                /** headers to attach to every single call just like interceptor */
