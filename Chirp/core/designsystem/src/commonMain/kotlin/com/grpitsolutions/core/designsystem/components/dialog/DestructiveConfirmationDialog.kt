package com.grpitsolutions.core.designsystem.components.dialog
...
@Composable
@Preview
fun DestructiveConfirmationDialogLightThemePreview() {
    ChirpTheme {
...
@Composable
@Preview
fun DestructiveConfirmationDialogDarkThemePreview() {
